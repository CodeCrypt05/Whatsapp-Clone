...
class PhoneNumberScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final phoneNumberController = Get.find<PhoneNumberScreenController>();
    ...
    return Scaffold(
      ...
      body: Form(
        key: phoneNumberController.numberForm,
        child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: CustomTextfieldWidget(
                        controller:
                            phoneNumberController.phoneNumberControllerText,
                        textInputType: TextInputType.number,
                ...
                child: Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      phoneNumberController.printNumber();
                    },
                    child: CustomButton(
                      label: "Next",
